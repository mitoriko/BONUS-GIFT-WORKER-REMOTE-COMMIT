...
namespace QuartzRedis.Common
{
    public abstract class DBHelp
    {
        ...
        /// </summary>
        /// <param name="SQLString">SQL语句</param>
        /// <param name="content">数据库连接串</param>
        /// <returns>标识列的值</returns>
        public static object ExecuteSqlGetID(string SQLString, string conString)
        {
        ...
        /// <param name="content">数据库连接串</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString, string conString)
        {
            using (SqlConnection connection = new SqlConnection(conString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
        ...
        public static DataSet Query(string SQLString, string conString)
        {
            using (SqlConnection connection = new SqlConnection(conString))
            {
                DataSet ds = new DataSet();
